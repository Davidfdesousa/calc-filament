...
export function renderLogin(root: HTMLElement): void {
  root.innerHTML = `
    <main class="login-screen">
      <div class="login-card">
        ...
        <p>Entre para calcular o custo das suas peças e manter suas configurações salvas na nuvem.</p>
  ...
  const button = root.querySelector<HTMLButtonElement>("#btn-google")!;
